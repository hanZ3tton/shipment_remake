...
<div class="container mt-4">
    <div class="card shadow">
        <div class="card-header bg-gradient-primary text-white">
            <h4 class="mb-0">Form Pengiriman & Inbound</h4>
        </div>
        <div class="card-body">
            <!-- Nav Tabs -->
            <ul class="nav nav-tabs" id="formTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="shipment-tab" data-bs-toggle="tab" data-bs-target="#shipment" type="button" role="tab">Informasi Pengiriman</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="inbound-tab" data-bs-toggle="tab" data-bs-target="#inbound" type="button" role="tab">Informasi Inbound</button>
                </li>
            </ul>
            ...
            <div class="tab-content mt-3" id="formTabsContent">
                ...
                <div class="tab-pane fade show active" id="shipment" role="tabpanel">
                    <form action="<?= base_url('app/shipment/save') ?>" method="post">
                ...
                <div class="tab-pane fade" id="inbound" role="tabpanel">
                    <form action="<?= base_url('inbound/save') ?>" method="post">
